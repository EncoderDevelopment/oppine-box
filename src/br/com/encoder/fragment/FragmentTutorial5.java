...
public class FragmentTutorial5 extends Fragment {
	...
	private void criaCompontes(View v) {
		...
		pular.setBackground(getResources().getDrawable(R.drawable.botao_pular));

		img.setImageDrawable(getResources().getDrawable(R.drawable.passo4));

		titilo.setText("Quarto passo!");
		tutorial.setText(
				"Você pode escolher entre várias opções de avaliação, com base na sua escolha os funcionários também concorrem a prêmios...");
