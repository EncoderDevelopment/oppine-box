...
public class FragmentCategorias7 extends Fragment {
	...
	public void preencheListaCategoriasFixa() {
		...
		categoriaEmpresas.add(new UnidadeCategoriaEmpresa(38, "Móveis", imagemRedonda
				.getRoundedCornerBitmap(BitmapFactory.decodeResource(getResources(), R.drawable.c38), 180)));
		categoriaEmpresas.add(new UnidadeCategoriaEmpresa(22, "Ônibus", imagemRedonda
				.getRoundedCornerBitmap(BitmapFactory.decodeResource(getResources(), R.drawable.c22), 180)));
		categoriaEmpresas.add(new UnidadeCategoriaEmpresa(50, "Óticas", imagemRedonda
		...
		categoriaEmpresas.add(new UnidadeCategoriaEmpresa(2, "Posto de combustível", imagemRedonda
