...
private void clickRapidoItemLista() {
	...
	public void preencheListaCategoriasFixa() {
		...
		categoriaEmpresas.add(new UnidadeCategoriaEmpresa(35, "Acessórios", imagemRedonda.getRoundedCornerBitmap(BitmapFactory.decodeResource(getResources(), R.drawable.c35), 180)));
		categoriaEmpresas.add(new UnidadeCategoriaEmpresa(49, "Acessórios para automóveis", imagemRedonda.getRoundedCornerBitmap(BitmapFactory.decodeResource(getResources(), R.drawable.c49), 180)));
		categoriaEmpresas.add(new UnidadeCategoriaEmpresa(23, "Aéreo", imagemRedonda.getRoundedCornerBitmap(BitmapFactory.decodeResource(getResources(), R.drawable.c23), 180)));
		categoriaEmpresas.add(new UnidadeCategoriaEmpresa(12, "Agência bancária", imagemRedonda.getRoundedCornerBitmap(BitmapFactory.decodeResource(getResources(), R.drawable.c12), 180)));
		categoriaEmpresas.add(new UnidadeCategoriaEmpresa(20, "Agência de turismo", imagemRedonda.getRoundedCornerBitmap(BitmapFactory.decodeResource(getResources(), R.drawable.c20), 180)));
