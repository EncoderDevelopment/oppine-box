...
public class FragmentTutorial3 extends Fragment {
	...
	private void criaCompontes(View v) {
		...
		img.setImageDrawable(getResources().getDrawable(R.drawable.passo2));

		titilo.setText("Segundo passo!");
		tutorial.setText(
				"Selecione uma empresa para ver a lista de funcionário. Selecione um funcionário na lista para avaliar o atendimento prestado por ele...");
