...
public class FragmentCategorias8 extends Fragment {
	...
	public void preencheListaCategoriasFixa() {
		...
		categoriaEmpresas.add(new UnidadeCategoriaEmpresa(8, "Restaurante", imagemRedonda
				.getRoundedCornerBitmap(BitmapFactory.decodeResource(getResources(), R.drawable.c8), 180)));
		categoriaEmpresas.add(new UnidadeCategoriaEmpresa(36, "Roupas", imagemRedonda
				.getRoundedCornerBitmap(BitmapFactory.decodeResource(getResources(), R.drawable.c36), 180)));
		categoriaEmpresas.add(new UnidadeCategoriaEmpresa(1, "Supermercado", imagemRedonda
				.getRoundedCornerBitmap(BitmapFactory.decodeResource(getResources(), R.drawable.c1), 180)));
		categoriaEmpresas.add(new UnidadeCategoriaEmpresa(21, "Táxi", imagemRedonda
				.getRoundedCornerBitmap(BitmapFactory.decodeResource(getResources(), R.drawable.c21), 180)));
		categoriaEmpresas.add(new UnidadeCategoriaEmpresa(6, "Telefonia", imagemRedonda
				.getRoundedCornerBitmap(BitmapFactory.decodeResource(getResources(), R.drawable.c6), 180)));
		categoriaEmpresas.add(new UnidadeCategoriaEmpresa(53, "Veículos automotores", imagemRedonda
				.getRoundedCornerBitmap(BitmapFactory.decodeResource(getResources(), R.drawable.c53), 180)));
	...
	public static FragmentCategorias8 newInstance(String text) {

		FragmentCategorias8 f = new FragmentCategorias8();
		Bundle b = new Bundle();
