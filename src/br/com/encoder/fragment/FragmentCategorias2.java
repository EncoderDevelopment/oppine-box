...
public class FragmentCategorias2 extends Fragment {
	...
	public void preencheListaCategoriasFixa() {
		...
		categoriaEmpresas.add(new UnidadeCategoriaEmpresa(4, "Auto peças", imagemRedonda
		...
		categoriaEmpresas.add(new UnidadeCategoriaEmpresa(43, "Beleza e estética", imagemRedonda
		...
		categoriaEmpresas.add(new UnidadeCategoriaEmpresa(33, "Calçados", imagemRedonda
