...
public class FragmentTutorial2 extends Fragment {
	...
	private void criaCompontes(View v) {
		...
		img.setImageDrawable(getResources().getDrawable(R.drawable.passo1));

		titilo.setText("Primeiro passo!");
		tutorial.setText(
				"Selecione uma categoria de empresa no menu de opções ou pesquise uma empresa. Você também pode sugerir uma empresa caso não encontre a que você procura...");
