...
public class CenarioMenuInformacoesAjudaAplicativo extends CCLayer implements ContratoBotaoMenu{
	...
	public CenarioMenuInformacoesAjudaAplicativo() {
	...
	private void criaComponentes() {
		informacoes = new ComponenteImagem(ConfiguracaoImagemCaminho.SOBRE_AJUDA);
	...
	private void setPosicao() {
		...
		informacoes.setPosition(CGPoint.ccp((larguraDaCena() / 2.f) -80, (alturaDaCena() / 2.f) -120));
